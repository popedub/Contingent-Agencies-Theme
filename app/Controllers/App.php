...
class App extends Controller
{
    ...
    public static function title()
    {
        ...
        if (!is_page() && !in_category(array('uncategorized', 'events', 'featured', 'researchers'))){
            return __('notation', 'sage');
        }
        if (!is_page() && in_category('researchers')){
...
*/
public static function getExcerpt($str, $startPos=0, $maxLength=400) {
